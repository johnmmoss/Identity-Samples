 ...
 * 
 * SHA-256, SHA-384 and SHA-512 XML signatures support also requires the use of an X.509 certificate whose associated 
 * cryptographic service provider (CSP) supports these algorithms.
 * For example, the Microsoft Enhanced RSA and AES Cryptographic Provider (ie CSP type 24) does support these algorithms.
 * 
 * If the current CSP doesn't support these algorithms, openssl may be used to specify the correct CSP.
 * This does not alter the actual key value. For more information, refer to the following forum topics.
 * 
...
namespace TestSHA256Signature
{
    class Program
    {
        ...
        private static void ShowUsage()
        {
            ...
            Console.Error.WriteLine("For example: TestSHA256Signature idp.pfx password");
        }
